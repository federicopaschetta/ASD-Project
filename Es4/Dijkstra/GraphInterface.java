...
/**
 * 
 * It represents a graph of T type Nodes and Double label edges
 * @author paschetta 
 * @author parusso 
 * @author lombardi
...
public interface GraphInterface<T> {
     ...
     */
    void addEdge(T source, T dest, Double label);
     ...
     */
    boolean containsEdge(T source, T dest, Double label);
     ...
     */
    void deleteEdge(T source, T dest, Double label);
