...
public class Heap<T>{
    ...
    /*
     * Inserts all elements in elemArray in heap
     * @param elemArray arrayList of T elements to be inserted in heap
     */
    public void buildHeap(ArrayList<T> elemArray) {
        try{
            if(elemArray == null) {
                throw new HeapException("buildHeap: cannot insert a null array");
            }
    ...
    */
    ...
    /**
     * If the element at the index given as parameter is minor than his parent, 
     * it switches his place with it in the ArrayList and switches his value in the HashTable and
     * recalls the method on his new place until it's minor than parent value
     * @param index the index if the element present in the Heap
     */
     ...
     * recalls the method on his new place until it's minor than both of his children
     * @param index the index if the element present in the Heap
     */
